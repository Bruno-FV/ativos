...
public class AuthController {
     ...
     * Injeta as dependências necessárias para autenticação e manipulação de usuários.
     *
     ...
     * Recebe os dados do usuário, criptografa a senha e salva no banco de dados.
     * Se nenhum role for especificado, define como ROLE_USER por padrão.
     *
     ...
     * Autentica as credenciais fornecidas e retorna um token JWT se válido.
     * O token contém informações do usuário (email e role) para autorização.
     *
